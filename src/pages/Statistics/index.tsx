...
import { BarChart3, PieChart, TrendingUp, Clock, Target, FileText, Filter } from 'lucide-react';
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">多维度分析门店诉求，跟踪闭环效果</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        <Card>
          <CardBody>
            <h3 className="font-semibold text-gray-900 mb-4">各区域需求分布</h3>
            <RegionChart />
          </CardBody>
        </Card>
        ...
        <Card>
          <CardBody>
            <h3 className="font-semibold text-gray-900 mb-4">模块需求占比</h3>
            <ModuleChart />
          </CardBody>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        <Card>
          <CardBody>
            <h3 className="font-semibold text-gray-900 mb-4">各区域状态分布</h3>
            <StatusChart />
          </CardBody>
        </Card>
